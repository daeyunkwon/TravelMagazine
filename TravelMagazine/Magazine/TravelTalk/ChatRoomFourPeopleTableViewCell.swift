//
//  ChatRoomFourPeopleTableViewCell.swift
//  TravelMagazine
//
...
class ChatRoomFourPeopleTableViewCell: UITableViewCell {
    ...
    var chatRoom: ChatRoom? {
        didSet {
            ...
            topProfileImageView.image = UIImage(named: chatRoom.chatroomImage[0])
            leftProfileImageView.image = UIImage(named: chatRoom.chatroomImage[1])
            rightProfileImageView.image = UIImage(named: chatRoom.chatroomImage[2])
    ...
    func configureUI() {
        topProfileImageView.layer.cornerRadius = topProfileImageView.frame.width / 2
        topProfileImageView.clipsToBounds = true
        topProfileImageView.contentMode = .scaleAspectFill
        topProfileImageView.layer.borderColor = UIColor.systemGray6.cgColor
        topProfileImageView.layer.borderWidth = 1
